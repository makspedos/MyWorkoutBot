...
class Muscle(models.Model):
    ...
    exercise = models.ManyToManyField('Exercise', default=None)
...
class Workout(models.Model):
    ...
    programs = models.ForeignKey(Program, on_delete=models.CASCADE, default=None)


    def __str__(self):
        return f'{self.name} + день {self.date}'
...
class Exercise(models.Model):
    id = models.AutoField(primary_key=True)
    name = models.CharField(max_length=45)
    workout = models.ManyToManyField(Workout,null=True, blank=True)
